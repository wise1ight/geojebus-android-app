...
public class RouteSearchAdapter extends CursorAdapter {
    HashMap<String, Bitmap> map = new HashMap<>();
    private BusDB mDbHelper;

    public RouteSearchAdapter(Context context, Cursor c) {
        super(context, c);
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        tv1.setText(cursor.getString(cursor.getColumnIndex("rt_name")));
        tv2.setText(cursor.getString(cursor.getColumnIndex("rt_name_extra")));
        iv1.setImageBitmap(countryLogo(cursor.getString(cursor.getColumnIndex("rt_country"))));
    }
